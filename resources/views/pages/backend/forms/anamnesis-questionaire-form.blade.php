                            ...
                            <div class="table-responsive">
                                <table id="mytable" class="table table-bordred table-striped">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td class="data">{{ __('Aktuelle Anamnese') }}</td>
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Frühere Anamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="previous_anamnesis" name="previous_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Vegetative Anamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="vegetative_anamnesis" name="vegetative_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Risikoanamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="risk_anamnesis" name="risk_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Medikamenten- und Suchtmittelanamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="drug_anamnesis" name="drug_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Geschlechterspezifische Anamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="gender_based_anamnesis" name="gender_based_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Familienanamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="family_anamnesis" name="family_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Sozialanamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="social_anamnesis" name="social_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        <td>{{ __('Sonstige Anamnese') }}</td>
                                        <td onclick="changeName(this)">
                                            <button class="btn btn-primary" id="moki-button">
                                                <i class="fa fa-pencil"></i>
                                            </button>
                                        </td>
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="further_anamnesis" name="further_anamnesis" value="4"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        ...
                                        <td><input type="text" class="form-control" style="max-width: 20%" id="suspected_diagnosis" name="suspected_diagnosis" value="1"></td>
                                        <td class="data">{{ __('Aktiv') }}</td>
                                        <td onclick="deactivateField(this)"><a href="#">{{ __('Deaktivieren') }}</a></td>
                                        <td onclick="deleteRow(this)">
                                            <button class="btn btn-danger" id="trash-button">
                                    ...
                                    <tr onClick="setActiveRow(this)">
                                        ...
                                        <td onClick="newRow(this)"><button class="btn btn-primary" id="moki-button">{{ __('Feld hinzufügen') }}</button></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    </tbody>
